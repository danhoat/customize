...
<div id="withdrawForm">
    <form class="et-form">
        <div class="form-group check-payment">
            <div class="radio">
                <label for="zelle_account">
                    <input type="radio" name="account_type" id="zelle_account" value="zelle" checked>
                    <span><?php _e('Zelle account', 'enginethemes'); ?></span>
                </label>
            </div>
            <div class="radio">
                <label for="paypal_account">
                    <input type="radio" name="account_type" id="paypal_account" value="paypal">
