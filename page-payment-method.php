            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-sx-12 payment-method box-shadow">
                <div class="tabs-information">
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="<?php echo (!isset($_GET['tab']) || (isset($_GET['tab']) && $_GET['tab'] == "zelle-account")) ? 'active' : '' ?>"><a href="#zelle-account" aria-controls="zelle-account" role="tab" data-toggle="tab"><?php _e('Zelle', 'enginethemes');?></a></li>
                        ...
                        <li role="presentation" class="<?php echo ((isset($_GET['tab']) && $_GET['tab'] == "bank-account")) ? 'active' : '' ?>"><a href="#bank-account" aria-controls="bank-account" role="tab" data-toggle="tab"><?php _e('Add a bank account', 'enginethemes');?></a></li>
                        <?php
/******
...
?>
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane <?php echo (!isset($_GET['tab']) || (isset($_GET['tab']) && $_GET['tab'] == "zelle-account")) ? 'active' : '' ?>" id="zelle-account">
                            <div id="zelleAccountForm">
                                <form class="et-form">
                                    <div class="form-group clearfix">
                                        <div class="input-group">
                                            <label for="zelle_email"><?php _e('Email', 'enginethemes');?></label>
                                            <input type="text" name="zelle_email" id="zelle_email" placeholder="" value="<?php echo $zelle_email; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group clearfix save-button-zelle">
                        ...
                        <div role="tabpanel" class="tab-pane <?php echo ((isset($_GET['tab']) && $_GET['tab'] == "bank-account")) ? 'active' : '' ?>" id="bank-account">
