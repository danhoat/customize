        ...
        <div class="container page-container">
            ...
            <div class="row block-page">
                <div class="blog-content info-payment-method">
                    <h1 class="title"><?php _e('Order Received', 'enginethemes-child'); ?></h1>

                    <p class="sub-title"><?php _e('Thank you. Your order has been received and is now being processed!', 'enginethemes-child'); ?></p>

                    <div class="invoice-detail">
                        <div class="mje-table">
                            <div class="mje-table-row">
                                <div class="mje-table-col">
                                    <span class="table-invoice-title"><?php _e('Invoice no', 'enginethemes-child') ?></span>
                                    <?php echo $order_data['ID']; ?>
                                </div>
                                <div class="mje-table-col">
                                    <span class="table-invoice-title"><?php _e('Date', 'enginethemes-child'); ?></span>
                                    <?php echo get_the_date(get_option('date_format'), $order_id); ?>
                                </div>
                                <div class="mje-table-col">
                                    <span class="table-invoice-title"><?php _e('Payment type', 'enginethemes-child') ?></span>
                                ...
                                <div class="mje-table-col">
                                    <span class="table-invoice-title"><?php _e('Total', 'enginethemes-child') ?></span>
                        ...
                        <?php if($order_data['payment'] == 'cash') : ?>
                            ...
                            <div class="invoice-note">
                                <p class="type-cash"><?php _e('CASH NOTE', 'enginethemes-child'); ?></p>
                    ...
                    <div class="link-detail-method">
                        <?php if($ad->post_type == 'mjob_post') : ?>
                            <a href="<?php echo get_the_permalink($ad->ID) ?>" class="<?php mje_button_classes( array( ) ); ?>"><?php _e('Visit your mJob', 'enginethemes-child'); ?><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                        <?php else :
